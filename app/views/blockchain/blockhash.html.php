<table class="table table-condensed table-striped table-bordered" style="background-color:white ">
	<tr>
		<td>Next Block </td>
		<td><code><a href="/blockchain/blockhash/<?php if(isset($nextblockhash)){echo $nextblockhash;}?>">
		<?php if(isset($nextblockhash)){echo $nextblockhash;}?></a></code></td>
		<td><?php if(isset($nextblock)){?>
		<a href="/blockchain/blocks/<?=$nextblock?>"><?=$nextblock?></a>
		<?php }?></td>
	</tr>	
	<tr>
		<td>Hash</td>
	...
	<tr>
		<td>Prev Block </td>
		<td><code><a href="/blockchain/blockhash/<?=$prevblockhash?>"><?=$prevblockhash?></a></code></td>
		<td><a href="/blockchain/blocks/<?=$prevblock?>"><?=$prevblock?></a></td>
	</tr>		
</table>
<h3>Details:</h3>
<table class="table table-condensed table-striped table-bordered" style="background-color:white ">
...
?>
	<tr>
		<td><?=$i?></td>
		<td><code><a href="/blockchain/transactionhash/<?php print_r($getblock['tx'][$i])?>"><?php print_r($getblock['tx'][$i])?></a></code></td>
	</tr>		
<?php }?>
</table>