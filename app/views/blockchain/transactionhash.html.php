...
<table class="table table-condensed table-striped table-bordered" style="background-color:white ">
	...
	<tr>
		...
		<td><code><a href="/blockchain/blockhash/<?php print_r($listsinceblock['lastblock'])?>"><?php print_r($listsinceblock['lastblock'])?></a></code></td>
	</tr>
...
?>
	<tr>
		<td>Tx ID</td>
		<td><strong><code><a href="/blockchain/transactionhash/<?php if(isset($in['txid'])){echo $in['txid'];}?>">
...
?>
	...
	<table class="table table-condensed table-striped table-bordered" style="background-color:white ">
		<thead>
			...
			<tr>
				<td><?php foreach($out['scriptPubKey']['addresses'] as $address){?>
